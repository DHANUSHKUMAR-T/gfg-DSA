<h2><a href="https://www.geeksforgeeks.org/problems/check-whether-k-th-bit-is-set-or-not-1587115620/1?page=8&sortBy=submissions">Check K-th Bit</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two positive integer <strong>n&nbsp;</strong>and&nbsp; <strong>k</strong>, check if the <strong>k<sup>th</sup></strong>&nbsp;index bit of&nbsp;<strong>n&nbsp;</strong>is set or not.<br><strong>&nbsp;Note: </strong></span><span style="font-size: 18px;">A bit is called set if it is 1.&nbsp;</span></p>
